...
from forge.adapters.sources.arxiv import ArxivAdapter
...
from forge.adapters.sources.hackernews import HackerNewsAdapter
from forge.adapters.sources.reddit import RedditAdapter
